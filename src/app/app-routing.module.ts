...
// Diamond
import {Demo} from './Diamond/demo/demo';
...
const routes: Routes = [
  {
    ...
    children: [
      ...
      {path: 'demo', component: Demo, data: {extraParameter: ''}},
      {path: 'login', component: Login, data: {extraParameter: ''}},
  ...
  },
  {
    ...
    children: [
      ...
      {path: 'Diamond/login-boxed', component: LoginBoxedComponent, data: {extraParameter: ''}},
      {path: 'Diamond/register-boxed', component: RegisterBoxedComponent, data: {extraParameter: ''}},
      {path: 'Diamond/forgot-password-boxed', component: ForgotPasswordBoxedComponent, data: {extraParameter: ''}},
    ]
  },
  {path: '**', redirectTo: ''}
];
